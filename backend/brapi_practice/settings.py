"""
Django settings for brapi_practice project.
...
SECRET_KEY = 'dorc66yp@vpumpn-epw!axzke0$g-tq!zcn55f*+u#b=&co5bh'
...
ROOT_URLCONF = 'brapi_practice.urls'
...
WSGI_APPLICATION = 'brapi_practice.wsgi.application'
